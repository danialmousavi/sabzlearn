            ...
            <div class="col-8">
              ...
              {/* Start Course Boxes  */}
                <div class="course-boxes">
                  <div class="row">
                    <CourseDetailBox title="وضعیت دوره:" text="به اتمام رسیده" icon="graduation-cap"/>
                    <CourseDetailBox title="مدت زمان دوره:" text=" 19 ساعت" icon="clock"/>
                    <CourseDetailBox title="آخرین بروزرسانی:" text="1401/03/02" icon="calendar-alt"/>
                    <CourseDetailBox title="روش پشتیبانی" text="آنلاین" icon="user-alt"/>
                    <CourseDetailBox title="پیش نیاز:" text="HTML CSS" icon="info-circle"/>
                    <CourseDetailBox title="نوع مشاهده:" text="ضبط شده / آنلاین" icon="play"/>
